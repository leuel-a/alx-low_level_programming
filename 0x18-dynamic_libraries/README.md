...
<br>First, during compile time, the linker verifies that all the symbols (again, functions, variables, 
...
file. <br>Instead, when the program is started, a program in the system (called a dynamic loader) checks 
